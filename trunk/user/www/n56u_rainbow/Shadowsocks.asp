...
<head>
	...
	<script type="text/javascript" src="/jquery.js?random=<% uptime(); %>">
	</script>
	<script type="text/javascript" src="/bootstrap/js/bootstrap.min.js">
	</script>
	<script type="text/javascript" src="/bootstrap/js/bootstrap-table.min.js">
	</script>
	<script type="text/javascript" src="/bootstrap/js/bootstrap-table-zh-CN.min.js">
	</script>
	...
	<script>
		var node_global_max = 0; <% shadowsocks_status(); %>
<% dns2tcp_status(); %>
		<% dnsproxy_status(); %>
<% rules_count(); %>
			node_global_max = 0;
		...
		function initial() {
			show_banner(2);
			show_menu('if-m1-syssettings', 'if-m2-ssr', 0);
			show_footer();
		...
		function actionFormatter(value, row, index) {
			return [
				'<a class="apply_ss" href="javascript:void(0)" title="应用"><i class="if if-tba-apply"></i></a>',
				'<a class="edit_ss" href="javascript:void(0)" title="编辑"><i class="if if-tba-edit"></i></a>',
				'<a class="copy_ss" href="javascript:void(0)" title="复制"><i class="if if-tba-copy"></i></a>',
				'<a class="del_ss" href="javascript:void(0)" title="删除"><i class="if if-tba-delete"></i></a>'
			].join(' | ');
		}
		window.operateEvents = {
			'click .apply_ss': function (e, value, row, index) {
				if (confirm('确认应用' + row.alias + '吗？')) {
					apply(row.ids);
				}
			},
		...
		function apply(id) {
			$j("#nodeList").val(id);
			$j("#u_nodeList").val('same');
			$j("#s5_nodeList").val('same');
			applyRule();
		}
		//批量删除
									...
									<div class="round_bottom">
										<div>
											<ul class="nav nav-tabs" style="margin-bottom: 10px;">
												<li class="active">
													<a id="tab_ss_cfg" href="#cfg">
														客户端
													</a>
												</li>
												<li>
													<a id="tab_ss_add" href="#add">
														节点管理
													</a>
												</li>
												<li>
													<a id="tab_ss_ssl" href="#ssl">
														高级设置
													</a>
												</li>
												<li>
													<a id="tab_ss_cli" href="#cli">
														规则管理
													</a>
												</li>
												<li>
													<a id="tab_ss_log" href="#log">
														运行日志
													</a>
												</li>
												<li>
													<a id="tab_ss_help" href="#help">
														帮助文档
													</a>
												</li>
											</ul>
										...
										<div class="row-fluid">
											...
											<div id="wnd_ss_cfg">
												<div class="alert alert-info" style="margin: 10px;">
													...
													<div>
														<span style="color:#E53333;">
															若被编辑的节点正在运行使用，请完成后点击“应用设置”更新节点信息并重连
														</span>
													</div>
													<div>
														<span style="color:#E53333;">
															运行状态不会实时更新，启动节点后需等待一段时间手动刷新页面获取运行状态
														</span>
													</div>
												</div>
												<table width="100%" cellpadding="4" cellspacing="0" class="table">
													...
													<tr id="row_pdnsd_run">
														...
														<td id="dns2tcp_status">
														</td>
													</tr>
													<tr id="row_dnsproxy_run">
														<th>
															dnsproxy<#running_status#>
														</th>
														<td id="dnsproxy_status">
														</td>
													</tr>
													<tr>
														<th>
															...
															<% nvram_match_x( "" , "ss_enable" , "0" , "value=0" ); %>
																...
																<div style="position: absolute; margin-left: -10000px;">
																	<input type="radio" value="1" name="ss_enable"
																		id="ss_enable_1" <% nvram_match_x( ""
																		, "ss_enable" , "1" , "checked" ); %>
																	>
																	<#checkbox_Yes#>
																		<input type="radio" value="0" name="ss_enable"
																			id="ss_enable_0" <% nvram_match_x( ""
																			, "ss_enable" , "0" , "checked" ); %>
																		>
																		<#checkbox_No#>
																</div>
													...
													<tr>
														...
														<td>
															<select name="ss_run_mode" id="ss_run_mode" class="input"
																style="width: 200px;">
																<option value="gfw" <% nvram_match_x( "" , "ss_run_mode"
																	, "gfw" , "selected" ); %>
																	> gfw列表模式
																</option>
																<option value="router" <% nvram_match_x( ""
																	, "ss_run_mode" , "router" , "selected" ); %>
																	> 绕过大陆IP模式
																</option>
																<option value="all" <% nvram_match_x( "" , "ss_run_mode"
																	, "all" , "selected" ); %>
																	> 全局模式
																</option>
																<option value="oversea" <% nvram_match_x( ""
																	, "ss_run_mode" , "oversea" , "selected" ); %>
																	> 海外用户回国模式
																</option>
															</select>
														</td>
													...
													<tr>
														...
														<td>
															<select name="s_dports" class="input" style="width: 200px;">
																<option value="0" <% nvram_match_x( "" , "s_dports"
																	, "0" , "selected" ); %>
																	> 所有端口（默认）
																</option>
																<option value="1" <% nvram_match_x( "" , "s_dports"
																	, "1" , "selected" ); %>
																	> 仅常用端口(不走P2P流量到代理)
																</option>
															</select>
													...
													<tr id="row_china_dns" style="display:none;">
														<th width="50%">
															国内DNS(仅chinadns-ng生效)
														</th>
														<td>
															<select name="china_dns" class="input"
																style="width: 200px;">
																<option value="223.5.5.5#53">
																	阿里DNS (223.5.5.5)
																</option>
																<option value="114.114.114.114#53">
																	114 DNS (114.114.114.114)
																</option>
																<option value="117.50.11.11#53">
																	OneDNS (117.50.11.11)
																</option>
																<option value="180.76.76.76#53">
																	百度DNS (180.76.76.76)
																</option>
																<option value="119.29.29.29#53">
																	DNSPOD DNS (119.29.29.29)
																</option>
																<option value="1.2.4.8#53">
																	cnnic DNS (1.2.4.8)
																</option>
															</select>
														</td>
													...
													<tr id="row_tunnel_forward" style="display:none;">
														...
														<td>
															<select name="tunnel_forward" class="input"
																style="width: 200px;">
																<option value="8.8.4.4#53">
																	Google Public DNS (8.8.4.4)
																</option>
																<option value="8.8.8.8#53">
																	Google Public DNS (8.8.8.8)
																</option>
																<option value="208.67.222.222#53">
																	OpenDNS (208.67.222.222)
																</option>
																<option value="208.67.220.220#53">
																	OpenDNS (208.67.220.220)
																</option>
																<option value="209.244.0.3#53">
																	Level 3 Public DNS (209.244.0.3)
																</option>
																<option value="209.244.0.4#53">
																	Level 3 Public DNS (209.244.0.4)
																</option>
																<option value="4.2.2.1#53">
																	Level 3 Public DNS (4.2.2.1)
																</option>
																<option value="4.2.2.2#53">
																	Level 3 Public DNS (4.2.2.2)
																</option>
																<option value="4.2.2.3#53">
																	Level 3 Public DNS (4.2.2.3)
																</option>
																<option value="4.2.2.4#53">
																	Level 3 Public DNS (4.2.2.4)
																</option>
																<option value="1.1.1.1#53">
																	Cloudflare DNS (1.1.1.1)
																</option>
																<option value="1.0.0.1#53">
																	Cloudflare DNS (1.0.0.1)
																</option>
																<option value="114.114.114.114#53">
																	Oversea Mode DNS-1 (114.114.114.114)
																</option>
																<option value="114.114.115.115#53">
																	Oversea Mode DNS-1 (114.114.115.115)
																</option>
															</select>
														</td>
													</tr>
												...
												<table width="100%" cellpadding="4" cellspacing="0" class="table">
													<tr>
														<th colspan="2" style="background-color: #E3E3E3;">
															订阅节点:添加完地址请先点击一下保存设置按钮,再点击更新订阅按钮。
														</th>
													</tr>
													<tr>
														<td colspan="3">
															...
															<div id="script7" style="display: none">
																<textarea rows="8" wrap="off" spellcheck="false"
																	...
																	style="font-family:'Courier New'; font-size:12px;">
																		<% nvram_dump( "scripts.ss_dlink.sh", ""); %>
																	</textarea>
															</div>
														</td>
													</tr>
															...
															<% nvram_match_x( "" , "ss_schedule_enable" , "0"
																...
																<div style="position: absolute; margin-left: -10000px;">
																	<input type="radio" name="ss_schedule_enable_x"
																		id="ss_schedule_enable_1" class="input"
																		value="1" <% nvram_match_x( ""
																		, "ss_schedule_enable" , "1" , "checked" ); %>
																	/>
																	<#checkbox_Yes#>
																		<input type="radio" name="ss_schedule_enable_x"
																			id="ss_schedule_enable_0" class="input"
																			value="0" <% nvram_match_x( ""
																			, "ss_schedule_enable" , "0" , "checked" );
																			%>
																		/>
																		<#checkbox_No#>
																</div>
													...
													<table width="100%" cellpadding="4" cellspacing="0" class="table"
														...
														<tr id="row_ss_password" style="display:none;">
															...
															<td>
																...
																<button style="margin-left: -5px;" class="btn"
																	type="button"
																	onclick="passwordShowHide('ss_password')">
																	<i class="if if-btn-eyeclose">
																	</i>
																</button>
															</td>
														</tr>
															...
															<td>
																<select name="ss_method" id="ss_method" class="input"
																	...
																	<option value="chacha20-ietf-poly1305">
																		chacha20-ietf-poly1305 (ss only)
																	</option>
																	<option value="xchacha20-ietf-poly1305">
																		xchacha20-ietf-poly1305 (ss only)
																	</option>
																</select>
															</td>
														</tr>
														<tr id="row_ss_protocol" style="display:none;">
															...
															<td>
																<select name="ss_protocol" id="ss_protocol"
																	...
																	<option value="auth_sha1">
																		auth_sha1
																	</option>
																	<option value="auth_sha1_v2">
																		auth_sha1_v2
																	</option>
																	<option value="auth_sha1_v4">
																		auth_sha1_v4
																	</option>
																	<option value="auth_aes128_md5">
																		auth_aes128_md5
																	</option>
																	<option value="auth_aes128_sha1">
																		auth_aes128_sha1
																	</option>
																	<option value="auth_chain_a">
																		auth_chain_a
																	</option>
																	<option value="auth_chain_b">
																		auth_chain_b
																	</option>
																</select>
															</td>
														...
														<tr id="row_ss_obfs" style="display:none;">
															...
															<td>
																<select name="ss_obfs" id="ss_obfs" class="input"
																	...
																	<option value="http_simple">
																		http_simple
																	</option>
																	<option value="http_post">
																		http_post
																	</option>
														...
														<tr id="row_s5_password" style="display:none;">
															...
															<td>
																...
																<button style="margin-left: -5px;" class="btn"
																	type="button"
																	onclick="passwordShowHide('s5_password')">
																	<i class="if if-btn-eyeclose">
																	</i>
																</button>
															</td>
														...
														<tr>
															<td>
																<center>
																	<input name="ManualRULESList2" id="ManualRULESList2"
																		type="button" class="btn btn-primary"
																		onclick="add_ss();" style="width: 219px"
																		value="保存节点" />
																</center>
															</td>
															<td>
											...
											<div id="wnd_ss_ssl" style="display:none">
												<table width="100%" cellpadding="4" cellspacing="0" class="table">
													...
													<tr>
														...
														<td>
															<input type="checkbox" id="ss_cgroups_fake" <%
																nvram_match_x("", "ss_cgroups" , "1" , "value=1 checked"
																); %>
															<% nvram_match_x("", "ss_cgroups" , "0" , "value=0" ); %>>
																<div style="position: absolute; margin-left: -10000px;">
													...
													<tr>
														...
														<td>
															<input type="text" class="input" size="15"
																name="ss_cgoups_cpu_s" style="width: 200px"
													...
													<tr>
														...
														<td>
															<input type="text" class="input" size="15"
																name="ss_cgoups_mem_s" style="width: 200px"
															...
															<% nvram_match_x( "" , "ss_watchcat" , "0" , "value=0" ); %>
																...
																<div style="position: absolute; margin-left: -10000px;">
																	<input type="radio" value="1" name="ss_watchcat"
																		id="ss_watchcat_1" <% nvram_match_x( ""
																		, "ss_watchcat" , "1" , "checked" ); %>
																	>
																	<#checkbox_Yes#>
																		<input type="radio" value="0" name="ss_watchcat"
																			id="ss_watchcat_0" <% nvram_match_x( ""
																			, "ss_watchcat" , "0" , "checked" ); %>
																		>
																		<#checkbox_No#>
																</div>
														</td>
												...
												<table width="100%" cellpadding="4" cellspacing="0" class="table">
															...
															<% nvram_match_x( "" , "ss_update_chnroute" , "0"
																...
																<div style="position: absolute; margin-left: -10000px;">
																	<input type="radio" value="1"
																		...
																		id="ss_update_chnroute_1" <% nvram_match_x( ""
																		, "ss_update_chnroute" , "1" , "checked" ); %>
																	>
																	<#checkbox_Yes#>
																		<input type="radio" value="0"
																			name="ss_update_chnroute"
																			id="ss_update_chnroute_0" <%
																			nvram_match_x( "" , "ss_update_chnroute"
																			, "0" , "checked" ); %>
																		>
																		<#checkbox_No#>
																</div>
													...
													<tr>
														...
														<td>
															<input type="checkbox" id="ss_update_gfwlist_fake" <%
																...
																, "value=1 checked" ); %>
															<% nvram_match_x( "" , "ss_update_gfwlist" , "0" , "value=0"
																); %>
																>
																<div style="position: absolute; margin-left: -10000px;">
																	<input type="radio" value="1"
																		name="ss_update_gfwlist"
																		id="ss_update_gfwlist_1" <% nvram_match_x( ""
																		, "ss_update_gfwlist" , "1" , "checked" ); %>
																	>
																	<#checkbox_Yes#>
																		<input type="radio" value="0"
																			name="ss_update_gfwlist"
																			id="ss_update_gfwlist_0" <%
																			nvram_match_x( "" , "ss_update_gfwlist"
																			, "0" , "checked" ); %>
																		>
																		<#checkbox_No#>
																</div>
													...
													<tr>
														<td colspan="3">
															...
															<a href="javascript:spoiler_toggle('script8')">
																<span>
																	不走SS代理的LAN IP:
																</span>
															</a>
															<div id="script8">
																<textarea rows="8" wrap="off" spellcheck="false"
																	...
																	style="font-family:'Courier New'; font-size:12px;">
																		<% nvram_dump( "scripts.ss_lan_ip.sh", ""); %>
																	</textarea>
															</div>
														</td>
													</tr>
													<tr>
														<td colspan="3">
															...
															<a href="javascript:spoiler_toggle('script9')">
																<span>
																	强制走SS代理的LAN IP:
																</span>
															</a>
															<div id="script9">
																<textarea rows="8" wrap="off" spellcheck="false"
																	...
																	style="font-family:'Courier New'; font-size:12px;">
																		<% nvram_dump( "scripts.ss_lan_bip.sh", ""); %>
																	</textarea>
															</div>
														</td>
													</tr>
													<tr>
														<td colspan="3">
															...
															<a href="javascript:spoiler_toggle('script13')">
																<span>
																	游戏模式LAN IP（客户端UDP所有端口,TCP跟随主服务器端口模式,强制走绕过大陆模式）:
																</span>
															</a>
															<div id="script13">
																<textarea rows="8" wrap="off" spellcheck="false"
																	...
																	style="font-family:'Courier New'; font-size:12px;">
																		<% nvram_dump( "scripts.ss_lan_gmip.sh", ""); %>
																	</textarea>
															</div>
														</td>
													</tr>
													<tr>
														<td colspan="3">
															...
															<a href="javascript:spoiler_toggle('script11')">
																<span>
																	强制走SS代理的WAN IP:
																</span>
															</a>
													...
													<tr>
														<td colspan="3">
															...
															<a href="javascript:spoiler_toggle('script12')">
																<span>
																	不走SS代理的WAN IP:
																</span>
															</a>
															<div id="script12">
																<textarea rows="8" wrap="off" spellcheck="false"
																	...
																	style="font-family:'Courier New'; font-size:12px;">
																		<% nvram_dump( "scripts.ss_wan_ip.sh", ""); %>
																	</textarea>
															</div>
														</td>
													</tr>
													<tr>
														<td colspan="3">
															...
															<a href="javascript:spoiler_toggle('script10')">
																<span>
																	强制走SS代理的域名:
																</span>
															</a>
													...
													<tr>
														<td colspan="3">
															...
															<a href="javascript:spoiler_toggle('script15')">
																<span>
																	不走SS代理的域名:
																</span>
															</a>
													...
													<tr>
														<td colspan="3"
															...
															<textarea rows="21" class="span12"
																...
																readonly="readonly" wrap="off" id="textarea">
																	<% nvram_dump( "ssrplus.log", ""); %>
																</textarea>
														</td>
													</tr>
													<tr>

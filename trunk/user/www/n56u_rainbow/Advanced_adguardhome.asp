...
<html>
	<head>
		...
		<script type="text/javascript" src="/help_b.js">
		</script>
		<script>
...
function initial() {
    show_banner(2);
    show_menu('if-m1-syssettings', 'if-m2-dnsservice');
    showmenu();
    show_footer();
}
	...
	<body onload="initial();" onunLoad="return unload_body();">
		...
		<div class="wrapper">
			...
			target="hidden_frame">
				...
				<input type="hidden" name="wan_ipaddr" value="<% nvram_get_x(" ", "wan0_ipaddr
				"); %>" readonly="1">
				<input type="hidden" name="wan_netmask" value="<% nvram_get_x(" ", "wan0_netmask
				"); %>" readonly="1">
										...
										<div class="round_bottom">
											...
											<div class="row-fluid">
												...
												<div class="alert alert-info" style="margin: 10px;">
													<p>
														AdGuard Home 是一款全网广告拦截与反跟踪软件。在您将其安装完毕后，它将保护您所有家用设备，同时您不再需要安装任何客户端软件。随着物联网与连接设备的兴起，掌控您自己的整个网络环境变得越来越重要。默认用户名密码均为adguardhome，可在/etc/storage/adg.sh内修改。
													</p>
													AdGuard Home 主页
													<a href="https://adguard.com/" target="blank">
														<i>
															<u>
																https://adguard.com/
															</u>
												...
												<table width="100%" align="center" cellpadding="4" cellspacing="0" class="table">
													<tr>
														...
														<td style="border-top: 0 none;">
															<input type="checkbox" id="adg_enable_fake" <% nvram_match_x( "",
															"adg_enable", "1", "value=1 checked"); %>
															<% nvram_match_x( "", "adg_enable", "0", "value=0"); %>
																/>
																<div style="position: absolute; margin-left: -10000px;">
																	<input type="radio" value="1" name="adg_enable" id="adg_enable_1" class="input"
																	value="1" <% nvram_match_x( "", "adg_enable", "1", "checked"); %>
																	/>
																	<#checkbox_Yes#>
																		<input type="radio" value="0" name="adg_enable" id="adg_enable_0" class="input"
																		value="0" <% nvram_match_x( "", "adg_enable", "0", "checked"); %>
																		/>
																		<#checkbox_No#>
																</div>
														</td>
													...
													<tr>
														<th>
															<a class="help_tooltip" href="javascript: void(0)" onmouseover="openTooltip(this, 1, 1);">
																DNS重定向
															</a>
														</th>
														<td>
													...
													<tr>
														...
														<td>
															<a href="http://<% nvram_get_x(" ", "lan_ipaddr "); %>:3030">
																http://
